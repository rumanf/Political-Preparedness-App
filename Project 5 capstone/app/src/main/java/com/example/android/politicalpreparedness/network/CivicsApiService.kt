...
const val API_KEY = "AIzaSyClJEdnPrn6zJXd0m5boEUgd-aC6H8ynAY"
...
interface CivicsApiService {
    ...
    @GET("elections")
    fun getElectionAPI(@Query("key") apiKey: String = API_KEY): Deferred<ElectionResponse>
    ...
    @GET("representatives")
    fun getRepsAPI(@Query("address") address: String):Deferred<RepresentativeResponse>
}
